  ...
  return (
    <footer className="bg-[#06112A] text-[#FAF7F2]">
      <Container className="py-12 lg:py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-[1.1fr_1.45fr_0.75fr_1.35fr] lg:gap-12">
          ...
          <div className="lg:border-r lg:border-[#C8A23D]/45 lg:pr-10">
            ...
            <div className="mt-5 flex flex-wrap gap-x-3 gap-y-2 font-body text-sm text-[#FAF7F2]/58">
            ...
            <p className="mt-3 font-body text-sm text-[#FAF7F2]/58">and surrounding areas.</p>
          </div>
          ...
          <div>
            ...
            <div className="mt-5 space-y-3 font-body text-sm text-[#FAF7F2]/62">
            ...
            <Link
              href="/contact"
              className="mt-6 inline-flex h-12 items-center justify-center border border-[#C8A23D] px-7 font-body text-[11px] font-semibold uppercase tracking-[0.16em] text-[#C8A23D] transition hover:bg-[#C8A23D] hover:text-[#06112A]"
            >
              Check Availability
            </Link>
          </div>
        ...
        <div className="mt-10 border-t border-[#FAF7F2]/8 pt-6 text-center">
          <p className="font-body text-xs text-[#FAF7F2]/45">
