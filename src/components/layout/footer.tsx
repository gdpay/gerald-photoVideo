      ...
      <Container className="py-3 lg:py-2">
        <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-2 lg:min-h-[56px] lg:grid-cols-[200px_minmax(260px,1fr)_130px_180px_180px] lg:items-stretch lg:gap-0">
          ...
          <div className="flex h-full flex-col justify-center lg:border-l lg:border-[#9C7A35] lg:px-6">
            ...
            <p className="mt-1 font-body text-[11px] text-[#FAF7F2]/82">and surrounding areas.</p>
          </div>
          ...
          <div className="flex h-full flex-col items-center justify-center lg:px-5">
            ...
            <div className="mt-1.5 flex items-center justify-center gap-2">
              <a href={SITE.social.instagram} target="_blank" rel="noopener noreferrer" className="text-[#FAF7F2] transition hover:text-[#C8A23D]" aria-label="Instagram">
              ...
              <a href={SITE.social.facebook} target="_blank" rel="noopener noreferrer" className="text-[#FAF7F2] transition hover:text-[#C8A23D]" aria-label="Facebook">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href={SITE.social.tiktok} target="_blank" rel="noopener noreferrer" className="text-[#FAF7F2] transition hover:text-[#C8A23D]" aria-label="TikTok">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href={SITE.social.youtube} target="_blank" rel="noopener noreferrer" className="text-[#FAF7F2] transition hover:text-[#C8A23D]" aria-label="YouTube">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex h-full flex-col items-center justify-center lg:border-l lg:border-[#9C7A35] lg:px-5">
            ...
            <div className="mt-1.5 flex flex-col items-start gap-1 font-body text-[11px] text-[#E3D6B8]">
              <a href={`mailto:${SITE.email}`} className="flex items-center gap-2 transition hover:text-[#C8A23D]">
                <Mail className="h-3 w-3 text-[#FAF7F2]" />
                {SITE.email}
              </a>
              <a href={`tel:${SITE.phoneRaw}`} className="flex items-center gap-2 transition hover:text-[#C8A23D]">
